...
<body>
  ...
  <main class="container my-5">
    <div class="row">
      ...
      <form action="tratamentologinprofissional.php" method="POST" id="form-login">
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-success w-100">Entrar</button>
         <div class="link-cadastro">
            ...
            <div class="mb-3">
            <a href="redefinirsenhaProfissional.php" class="icon-link icon-link-hover link-success link-underline-success link-underline-opacity-25" >Redefina sua senha
